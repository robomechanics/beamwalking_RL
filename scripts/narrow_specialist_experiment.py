"""Train a narrow-stance single-gait specialist (stance width 0.05-0.30 m).

Same curriculum, duty anchors, periods, plant and PPO as the gait specialists,
with narrow widths, a 3 cm placement tolerance, self-collision on and no domain
randomization. See narrow_specialist.py.
"""
...
from beam_walking.experiment.narrow_specialist import (  # noqa: E402
    ...
    NARROW_TASK_FILES as UNIFIED_TASK_FILES,
    NARROW_TRAINING_ITERATIONS as UNIFIED_TRAINING_ITERATIONS,
    NARROW_TRAINING_NUM_ENVS as UNIFIED_TRAINING_NUM_ENVS,
    NARROW_TRAINING_SEED as UNIFIED_TRAINING_SEED,
    NARROW_TRAINING_SOURCE_FILES as UNIFIED_TRAINING_SOURCE_FILES,
    NARROW_WIDTH_ANCHORS,
    NARROW_WIDTH_RANGE,
    files_sha256,
    narrow_extension_record,
    narrow_lineage_id as specialist_lineage_id,
)
...
if args.mode == "train" and not args.development and (
    ...
    parser.error(
        "Primary specialist training requires 3072 environments, 1800 updates, "
...
def main():
    ...
    try:
        ...
        lineage = specialist_lineage_id(training_source_sha256, args.seed, args.gait)
        provenance = {
            ...
            "protocol": "narrow_stance_single_gait_specialist",
            "step_width_range_m": list(NARROW_WIDTH_RANGE),
            "step_width_anchors_m": list(NARROW_WIDTH_ANCHORS),
        ...
        if args.mode == "smoke":
            ...
            print("NARROW_SPECIALIST_SMOKE_OK", json.dumps(result), flush=True)
            return
        ...
        print("NARROW_SPECIALIST_TRAINING_COMPLETE", json.dumps(throughput), flush=True)
    finally:
