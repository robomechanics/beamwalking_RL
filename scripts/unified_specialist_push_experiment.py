...
from beam_walking.experiment.unified_specialist import files_sha256  # noqa: E402
from beam_walking.experiment.unified_specialist_push import (  # noqa: E402
...
from beam_walking.experiment.unified_specialist_task import (  # noqa: E402
    SpecialistEnv as UnifiedEnv,
    SpecialistEnvCfg as UnifiedEnvCfg,
    SpecialistPPORunnerCfg as UnifiedPPORunnerCfg,
)
...
def main():
    ...
    try:
        ...
        provenance = {
            ...
            "protocol": "unified_gait_plan_single_gait_specialist",
        ...
        if args.mode == "smoke":
            ...
            print("UNIFIED_SPECIALIST_PUSH_SMOKE_OK", json.dumps(result), flush=True)
            return
        ...
        print("UNIFIED_SPECIALIST_PUSH_TRAINING_COMPLETE", json.dumps(throughput), flush=True)
    finally:
