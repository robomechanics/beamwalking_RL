"""Train a single-gait specialist under the unified protocol.

Same curriculum, plant, reward, and PPO as the unified policy; every command
carries the gait given by --gait. See docs/unified_gait_plan.md.
"""
...
from beam_walking.experiment.unified_specialist import (  # noqa: E402
    SPECIALIST_SCHEMA,
    SPECIALIST_TASK_FILES as UNIFIED_TASK_FILES,
    SPECIALIST_TRAINING_ITERATIONS as UNIFIED_TRAINING_ITERATIONS,
    SPECIALIST_TRAINING_NUM_ENVS as UNIFIED_TRAINING_NUM_ENVS,
    SPECIALIST_TRAINING_SEED as UNIFIED_TRAINING_SEED,
    SPECIALIST_TRAINING_SOURCE_FILES as UNIFIED_TRAINING_SOURCE_FILES,
    files_sha256,
    specialist_lineage_id,
)
...
def main():
    ...
    try:
        ...
        if args.mode == "smoke":
            ...
            print("UNIFIED_SPECIALIST_SMOKE_OK", json.dumps(result), flush=True)
            return
        ...
        print("UNIFIED_SPECIALIST_TRAINING_COMPLETE", json.dumps(throughput), flush=True)
    finally:
